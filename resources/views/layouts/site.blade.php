...
<div class="topbar">
    <div class="wrap">
        <div class="topbar-left">
            <a href="https://maps.google.com/?q=414+Main+St+Asbury+Park+NJ+07712" target="_blank" rel="noopener">
            ...
            <a href="mailto:info@kaypaoloshipping.com">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<header class="site" id="siteHeader">
    <div class="wrap nav-wrap">
        <a href="{{ route('home') }}" class="brand">
            <img src="{{ asset('kay-paolo/assets/logo/kay-paolo.svg') }}" alt="Kay Paolo Shipping" width="120" height="60">
        </a>
...
<footer class="site">
    <div class="wrap footer-grid">
        <div class="footer-brand">
            ...
            <p>Ocean, air and land freight with customs clearance and live tracking - one desk, start to finish.</p>
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="{{ route('contact') }}">Get In Touch</a></li>
                <li><a href="{{ route('contact') }}">Support 24/7</a></li>
            </ul>
        </div>
        <div>
            <h5>Our Services</h5>
    ...
    <div class="wrap footer-bottom">
        <span>&copy; 2026 Kay Paolo Shipping Co. | Freight &amp; Logistics</span>
        <span><a href="#">Privacy</a> / <a href="#">Terms &amp; Conditions</a> / <a href="{{ route('contact') }}">Contact</a></span>
    </div>
</footer>

<a class="whatsapp-fab" href="https://wa.me/17328989303" target="_blank" rel="noopener" aria-label="WhatsApp">
